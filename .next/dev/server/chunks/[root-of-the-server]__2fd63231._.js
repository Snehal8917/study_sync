...
async function POST(request) {
    try {
        ...
        const { email, password } = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$validations$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["loginSchema"].parse(body);
        ...
        const isValidPassword = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$bcrypt$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["comparePassword"])(password, user.password);
        if (!isValidPassword) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Invalid credentials"
            }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2fd63231._.js.map